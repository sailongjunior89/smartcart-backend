...
INSERT INTO product (id, name, description, price, image_url, gender, color, category_id, user_id, shop_name, status, admin_locked, created_at) VALUES
                                                                                                                               -- Tops
                                                                                                                               (1, 'Classic Crew Tee', 'A soft, everyday cotton crew-neck tee.', 19.90, '/assets/products/tee-crew.jpg', 'MEN', 'White', 1, 1, 'SmartCart Official', 'ACTIVE', FALSE, DATE_SUB(NOW(), INTERVAL 1 DAY)),
                                                                                                                               (2, 'Linen Shirt', 'Breathable linen button-up with a relaxed collar.', 39.90, '/assets/products/linen-shirt.jpg', 'MEN', 'Beige', 1, 1, 'SmartCart Official', 'ACTIVE', FALSE, DATE_SUB(NOW(), INTERVAL 3 DAY)),
                                                                                                                               (3, 'Oversized Pocket Tee', 'Heavyweight oversized tee with a chest pocket.', 24.90, '/assets/products/tee-pocket.jpg', 'MEN', 'Grey', 1, 1, 'SmartCart Official', 'ACTIVE', FALSE, DATE_SUB(NOW(), INTERVAL 2 DAY)),
                                                                                                                               ...
                                                                                                                               (13, 'Polo Shirt', 'Pique cotton polo with a classic collar.', 34.90, '/assets/products/polo-shirt.jpg', 'MEN', 'Navy', 1, 1, 'SmartCart Official', 'ACTIVE', FALSE, DATE_SUB(NOW(), INTERVAL 3 DAY)),
                                                                                                                               ...
                                                                                                                               (15, 'Turtleneck Sweater', 'Ribbed turtleneck sweater for layering.', 44.90, '/assets/products/turtleneck-sweater.jpg', 'WOMEN', 'Cream', 1, 1, 'SmartCart Official', 'ACTIVE', FALSE, DATE_SUB(NOW(), INTERVAL 5 DAY)),
                                                                                                                               (16, 'Henley Shirt', 'Waffle-knit henley with a button placket.', 29.90, '/assets/products/henley-shirt.jpg', 'MEN', 'Olive', 1, 1, 'SmartCart Official', 'ACTIVE', FALSE, DATE_SUB(NOW(), INTERVAL 6 DAY)),
                                                                                                                               ...
                                                                                                                               -- Bottoms
                                                                                                                               (4, 'Chino Shorts', 'Relaxed-fit cotton chino shorts.', 34.90, '/assets/products/chino-shorts.jpg', 'MEN', 'Khaki', 2, 1, 'SmartCart Official', 'ACTIVE', FALSE, DATE_SUB(NOW(), INTERVAL 10 DAY)),
                                                                                                                               ...
                                                                                                                               (6, 'Wide-Leg Trousers', 'Flowy wide-leg trousers in olive cotton twill.', 44.90, '/assets/products/wide-leg-trousers.jpg', 'WOMEN', 'Olive', 2, 1, 'SmartCart Official', 'ACTIVE', FALSE, DATE_SUB(NOW(), INTERVAL 6 DAY)),
                                                                                                                               (21, 'Cargo Pants', 'Utility cargo pants with side pockets.', 49.90, '/assets/products/cargo-pants.jpg', 'WOMEN', 'Beige', 2, 1, 'SmartCart Official', 'ACTIVE', FALSE, DATE_SUB(NOW(), INTERVAL 1 DAY)),
                                                                                                                               ...
                                                                                                                               (23, 'Track Pants', 'Striped track pants with a tapered leg.', 44.90, '/assets/products/track-pants.jpg', 'WOMEN', 'Grey', 2, 1, 'SmartCart Official', 'ACTIVE', FALSE, DATE_SUB(NOW(), INTERVAL 3 DAY)),
                                                                                                                               ...
                                                                                                                               (26, 'Linen Trousers', 'Breathable linen trousers with side pockets.', 44.90, '/assets/products/linen-trousers.jpg', 'MEN', 'Beige', 2, 1, 'SmartCart Official', 'ACTIVE', FALSE, DATE_SUB(NOW(), INTERVAL 6 DAY)),
                                                                                                                               ...
                                                                                                                               (29, 'Culottes', 'Wide-leg cropped culottes in a print.', 39.90, '/assets/products/culottes.jpg', 'WOMEN', 'Beige', 2, 1, 'SmartCart Official', 'ACTIVE', FALSE, DATE_SUB(NOW(), INTERVAL 9 DAY)),
                                                                                                                               (30, 'Sweatpants', 'Fleece-lined jogger sweatpants.', 34.90, '/assets/products/sweatpants.jpg', 'WOMEN', 'Grey', 2, 1, 'SmartCart Official', 'ACTIVE', FALSE, DATE_SUB(NOW(), INTERVAL 10 DAY)),
                                                                                                                               -- Shoes
                                                                                                                               ...
                                                                                                                               (9, 'Strappy Sandals', 'Single-strap leather sandals with a low heel.', 44.90, '/assets/products/strappy-sandals.jpg', 'WOMEN', 'Tan', 3, 1, 'SmartCart Official', 'ACTIVE', FALSE, DATE_SUB(NOW(), INTERVAL 12 DAY)),
                                                                                                                               (10, 'Running Shoes', 'Lightweight breathable trainers with cushioned sole.', 79.90, '/assets/products/running-shoes.jpg', 'MEN', 'Grey', 3, 1, 'SmartCart Official', 'ACTIVE', FALSE, DATE_SUB(NOW(), INTERVAL 9 DAY)),
                                                                                                                               ...
                                                                                                                               (36, 'Espadrilles', 'Canvas espadrilles with a woven jute sole.', 39.90, '/assets/products/espadrilles.jpg', 'WOMEN', 'Beige', 3, 1, 'SmartCart Official', 'ACTIVE', FALSE, DATE_SUB(NOW(), INTERVAL 6 DAY)),
                                                                                                                               ...
                                                                                                                               (39, 'Ballet Flats', 'Soft leather ballet flats.', 44.90, '/assets/products/ballet-flats.jpg', 'WOMEN', 'Nude', 3, 1, 'SmartCart Official', 'ACTIVE', FALSE, DATE_SUB(NOW(), INTERVAL 9 DAY)),
